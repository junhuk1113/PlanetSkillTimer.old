...
public class SkillLevel {
    private static final int[][] skillTimetable = {
            {15000, 3800, 135000}, //농사 : 재보충
            {15000, 1500, 198000}, //벌목 : 벌목기
            {5000, 5000, 200000}, //채광 : 빠른채광
            {5000, 1000, 295000} //발굴 : 지형수정
            //ms
    };
    ...
    public static int getCooldownTime(int skilltype){
        return skillTimetable[skilltype][2];
    }
}